...
Currently **NutritionTools** offers 16 tools to help with 5 key areas; Nutritional Calculations, Food Matching, Food Dataset Management, Output Summaries and Checks, and Data Imputation - although further functions are still in development and are set to be added at a later time.
