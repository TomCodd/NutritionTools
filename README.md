...
Currently **NutritionTools** offers 19 tools to help with 6 key areas; Nutritional Calculations, Food Matching, Food Dataset Management, Output Summaries and Checks, Data Imputation, and Package helper functions - although further functions are still in development and are set to be added at a later time.
