...
#' Column names are case sensitive and an error is returned if not found. Non-numeric
#' columns will be converted if possible in function to be numeric.
